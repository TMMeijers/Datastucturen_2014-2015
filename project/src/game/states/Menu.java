...
public class Menu extends BasicGameState {
	...
	public void init(GameContainer gc, StateBasedGame sbg) throws SlickException {
		...
		FONT_SMALL = new UnicodeFont("res/ui/fonts/Knights_Quest.ttf", 28, false, false);
		FONT_NORMAL = new UnicodeFont("res/ui/fonts/Knights_Quest.ttf", 40, false, false);
		FONT_LARGE = new UnicodeFont("res/ui/fonts/Knights_Quest.ttf", 60, false, false);
		...
		// play against AI
		LegendsOfArborea.GAME = new DefaultGame(LegendsOfArborea.NAME_P1, true);
	}
